...
#-Wpadded 
DEBUG_CFLAGS=-std=gnu99 -Wall -Wno-nonnull-compare -Wextra -pedantic-errors -Werror -g -O0 
DEBUG_DIR=bin/debug
DEBUG_OBJECTS=$(patsubst src/%.c, $(DEBUG_DIR)/%.o, $(SOURCES))
DEBUG_MAIN_OBJECT=$(DEBUG_DIR)/main.o
DEBUG_EXE=$(DEBUG_DIR)/medusa

RELEASE_CFLAGS=-std=gnu99 -Wall -Wno-nonnull-compare -Wextra -pedantic-errors -Werror -O2 -g
...
TEST_CFLAGS=-std=gnu99 -Wall -Wno-nonnull-compare -Wextra -fprofile-arcs -ftest-coverage -g -O0
TEST_DIR=bin/test
